...
lambda-process:
	...
	GOOS=linux go build -mod vendor -ldflags="-s -w" -o main cmd/iiif-process/main.go
...
lambda-transform:
	...
	GOOS=linux go build -mod vendor -ldflags="-s -w" -o main cmd/iiif-transform/main.go
...
lambda-tileseed:
	...
	GOOS=linux go build -mod vendor -ldflags="-s -w" -o main cmd/iiif-tile-seed/main.go
